  ...
  useEffect(() => {
    const fetchCeramics = async () => {
      ...
      try {
        ...
        setError(`Could not load ceramics: ${err.message}`);
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="min-h-screen text-2xl font-sans bg-[#fdfbe0]">
      ...
      >
        ...
        >
          ...
          <h1 className={elementClasses}>mudmuddd</h1>
      ...
      <main className="max-w-7xl mx-auto py-12 px-4" style={{ color: STYLE_CONFIG.brandColor }}>
        {loading && <div className="text-center p-8">Loading ceramics...</div>}
